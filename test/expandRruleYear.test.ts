...
describe('expandRruleYear', () => {
  it(`expand rRule Year`, () => {
    const rRule =
    ...
    if (r) {
      ...
      expect(r.events[0].date.toISOString()).toEqual('2023-12-15T10:00:00.000Z')
      expect(r.events[1].date.toISOString()).toEqual('2024-12-15T10:00:00.000Z')
      expect(r.events[2].date.toISOString()).toEqual('2025-12-15T10:00:00.000Z')
      expect(r.events[3].date.toISOString()).toEqual('2026-12-15T10:00:00.000Z')
    }
  })

  it(`expand rRule Year byMonth and byMonthDay`, () => {
    const rRule =
    ...
    if (r) {
      ...
      expect(r.events[0].date.toISOString()).toEqual('2022-12-27T10:00:00.000Z')
      expect(r.events[1].date.toISOString()).toEqual('2023-12-27T10:00:00.000Z')
      expect(r.events[2].date.toISOString()).toEqual('2024-12-27T10:00:00.000Z')
      expect(r.events[3].date.toISOString()).toEqual('2025-12-27T10:00:00.000Z')
      expect(r.events[4].date.toISOString()).toEqual('2026-12-27T10:00:00.000Z')
    }
  })

  it(`expand rRule Year byMonth and byMonthDay in range`, () => {
    const rRule =
    ...
    if (r) {
      ...
      expect(r.events[0].date.toISOString()).toEqual('2025-01-27T10:00:00.000Z')
      const index = 5
  ...
  it(`expand rRule Year byMonth and byMonthDay  until`, () => {
    const rRule =
    ...
    if (r) {
      ...
      expect(r.events[0].date.toISOString()).toEqual('2023-01-20T12:34:56.000Z')
    }
  })

  it(`expand rRule Year byMonth bySetPos`, () => {
    const rRule =
    ...
    if (r) {
      ...
      expect(r.events[0].date.toISOString()).toEqual('2023-01-09T10:00:00.000Z')
      expect(r.events[1].date.toISOString()).toEqual('2024-01-08T10:00:00.000Z')
      expect(r.events[2].date.toISOString()).toEqual('2025-01-13T10:00:00.000Z')
      expect(r.events[3].date.toISOString()).toEqual('2026-01-12T10:00:00.000Z')
      expect(r.events[4].date.toISOString()).toEqual('2027-01-11T10:00:00.000Z')
    }
  })

  it(`expand rRule Year byMonth bySetPos in range`, () => {
    const rRule =
    ...
    if (r) {
      ...
      expect(r.events[0].date.toISOString()).toEqual('2024-01-08T10:00:00.000Z')
      expect(r.events[1].date.toISOString()).toEqual('2025-01-13T10:00:00.000Z')
