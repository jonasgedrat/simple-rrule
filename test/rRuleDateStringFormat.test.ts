...
describe('rRuleDateStringFormat', () => {
  ...
  describe('toRRuleDateString', () => {
    it('should handle UTC mode correctly', () => {
      const result = toRRuleDateString(dateString, true)
      expect(result).toBe('20221215T152030Z')
    })

    it('should handle local time mode correctly', () => {
      const result = toRRuleDateString(dateString, false)
    ...
    it('should pad single digits correctly', () => {
      const date = '2001-01-01T01:01:01.000Z'
  ...
  describe('fromRruleDateStringToDate', () => {
    it('should throw error for invalid format', () => {
      expect(() => fromRruleDateStringToDate('invalid')).toThrow(errorString)
      expect(() => fromRruleDateStringToDate('20221215')).toThrow(errorString)
    ...
    it('should handle edge cases for days in month', () => {
      expect(() => fromRruleDateStringToDate('20220131T120000Z')).not.toThrow()
      expect(() => fromRruleDateStringToDate('20220430T120000Z')).not.toThrow()
    })
    ...
    it('should ignore milliseconds in input', () => {
      ...
      expect(result1).toBe('2022-12-15T15:20:30.000Z')
      expect(result2).toBe('2022-12-15T15:20:30.000Z')
      expect(result3).toBe('2022-12-15T15:20:30.000Z')
    })
    ...
    it('should handle boundary years', () => {
      ...
      expect(new Date(result1).getUTCFullYear()).toBe(1000)
      expect(new Date(result2).getUTCFullYear()).toBe(2999)
    })
  })
  ...
  describe('round-trip conversion', () => {
    it('should maintain consistency in round-trip conversion', () => {
      const originalDates = [
        ...
        '2020-02-29T12:30:45.000Z', // Leap year
      ]
