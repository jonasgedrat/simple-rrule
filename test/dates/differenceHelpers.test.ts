...
describe('differenceHelpers', () => {
  describe('differenceInYears', () => {
    ...
    it('should handle leap year calculations correctly', () => {
      ...
      expect(
        differenceInYears(new Date(2021, 1, 28), new Date(2020, 1, 29))
      ).toEqual(0)

      // February 29, 2020 to March 1, 2021 should be 1 year
      expect(
        differenceInYears(new Date(2021, 2, 1), new Date(2020, 1, 29))
      ).toEqual(1)
    })
    ...
    it('should handle partial years correctly', () => {
      ...
      expect(
        differenceInYears(new Date(2020, 11, 31), new Date(2020, 0, 1))
      ).toEqual(0)

      // January 1, 2020 to January 1, 2021 should be 1 year
      expect(
        differenceInYears(new Date(2021, 0, 1), new Date(2020, 0, 1))
      ).toEqual(1)
    })
    ...
    it('should handle cross-century calculations', () => {
      expect(
        differenceInYears(new Date(2000, 0, 1), new Date(1999, 0, 1))
      ).toEqual(1)
      expect(
        differenceInYears(new Date(1900, 0, 1), new Date(2000, 0, 1))
      ).toEqual(-100)
    })
  })
  ...
  describe('differenceInMonths', () => {
    ...
    it('should handle partial months correctly', () => {
      ...
      expect(
        differenceInMonths(new Date(2020, 0, 31), new Date(2020, 0, 1))
      ).toEqual(0)

      // January 1 to February 1 should be 1 month
      expect(
        differenceInMonths(new Date(2020, 1, 1), new Date(2020, 0, 1))
      ).toEqual(1)
    })
    ...
    it('should handle end of month dates correctly', () => {
      ...
      expect(
        differenceInMonths(new Date(2020, 1, 29), new Date(2020, 0, 31))
      ).toEqual(1)

      // January 31 to February 28 (non-leap year) should be 1 month
      expect(
        differenceInMonths(new Date(2021, 1, 28), new Date(2021, 0, 31))
      ).toEqual(1)
    })
    ...
    it('should handle February edge cases', () => {
      ...
      expect(
        differenceInMonths(new Date(2021, 2, 28), new Date(2021, 1, 28))
      ).toEqual(1)

      // February 29 (leap year) to March 29 should be 1 month
      expect(
        differenceInMonths(new Date(2020, 2, 29), new Date(2020, 1, 29))
      ).toEqual(1)
    })

    it('should handle cross-year calculations', () => {
      expect(
        differenceInMonths(new Date(2021, 0, 1), new Date(2020, 11, 1))
      ).toEqual(1)
      expect(
        differenceInMonths(new Date(2021, 5, 15), new Date(2020, 0, 15))
      ).toEqual(17)
    })
  ...
  describe('differenceInWeeks', () => {
    ...
    it('should handle fractional weeks', () => {
      ...
      expect(differenceInWeeks(addDays(_d, 10), _d)).toBeCloseTo(
        1.4285714285714286
      )
    })
  ...
  describe('differenceInCalendarMonths', () => {
    it('should calculate basic calendar month differences', () => {
      ...
      expect(
        differenceInCalendarMonths(new Date(2014, 8, 1), new Date(2014, 0, 31))
      ).toEqual(8)
    })

    it('should return 0 for same month', () => {
      expect(
        differenceInCalendarMonths(new Date(2020, 0, 31), new Date(2020, 0, 1))
      ).toEqual(0)
    })
    ...
    it('should handle cross-year calculations', () => {
      ...
      expect(
        differenceInCalendarMonths(new Date(2020, 0, 1), new Date(2019, 11, 31))
      ).toEqual(1)

      // January 2020 to December 2020 should be 11 calendar months
      expect(
        differenceInCalendarMonths(new Date(2020, 11, 1), new Date(2020, 0, 1))
      ).toEqual(11)
    })
    ...
    it('should handle negative differences', () => {
      ...
      expect(
        differenceInCalendarMonths(new Date(2020, 0, 1), new Date(2020, 5, 1))
      ).toEqual(-5)
    })
    ...
    it('should handle multi-year differences', () => {
      ...
      expect(
        differenceInCalendarMonths(new Date(2022, 3, 1), new Date(2020, 0, 1))
      ).toEqual(27)
    })
    ...
    it('should ignore day differences within the same calendar month', () => {
      ...
      expect(
        differenceInCalendarMonths(new Date(2020, 5, 30), new Date(2020, 5, 1))
      ).toEqual(0)
    })
