...
describe('getStartOfWeekWithoutChangeTime', () => {
    ...
    describe('edge cases and boundary conditions', () => {
        it('should handle month boundary correctly', () => {
            ...
            const result = getStartOfWeekWithoutChangeTime(
                firstDayOfMonth,
                wkst
            )
    ...
    describe('comprehensive weekday testing with Monday start', () => {
        ...
        it('should handle all days of the week correctly', () => {
            const testCases = [
                {
                    day: 'Sunday',
                    date: new Date(`2024-01-21${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
                {
                    day: 'Monday',
                    date: new Date(`2024-01-15${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
                {
                    day: 'Tuesday',
                    date: new Date(`2024-01-16${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
                {
                    day: 'Wednesday',
                    date: new Date(`2024-01-17${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
                {
                    day: 'Thursday',
                    date: new Date(`2024-01-18${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
                {
                    day: 'Friday',
                    date: new Date(`2024-01-19${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
                {
                    day: 'Saturday',
                    date: new Date(`2024-01-20${baseTime}`),
                    expectedStart: new Date(`2024-01-15${baseTime}`),
                },
            ]
    ...
    describe('comprehensive weekday testing with Sunday start', () => {
        ...
        it('should handle all days of the week correctly', () => {
            const testCases = [
                {
                    day: 'Sunday',
                    date: new Date(`2024-01-14${baseTime}`),
                    expectedStart: new Date(`2024-01-14${baseTime}`),
                },
                {
                    day: 'Monday',
                    date: new Date(`2024-01-15${baseTime}`),
