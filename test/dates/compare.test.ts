...
describe('isLastDayOfMonth', () => {
  ...
  it('should preserve time precision when checking', () => {
    ...
    expect(isLastDayOfMonth(new Date(2020, 0, 31, 23, 59, 59, 999))).toEqual(
      true
    )
    expect(isLastDayOfMonth(new Date(2020, 0, 31, 12, 30, 45, 123))).toEqual(
      true
    )
  })
})
...
describe('compareAsc', () => {
  it('should return -1 when first date is before second date', () => {
    expect(compareAsc(new Date(1987, 1, 11), new Date(1989, 6, 10))).toEqual(-1)
  ...
  it('should return 1 when first date is after second date', () => {
    expect(compareAsc(new Date(1989, 6, 10), new Date(1987, 1, 11))).toEqual(1)
  ...
  it('should handle very old and future dates', () => {
    expect(compareAsc(new Date(1900, 0, 1), new Date(2100, 0, 1))).toEqual(-1)

    expect(compareAsc(new Date(2100, 0, 1), new Date(1900, 0, 1))).toEqual(1)
  })
})
