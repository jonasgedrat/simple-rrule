...
export const setByMonth = (date: Date, month: YearMonths): Date => {
  if (month < 1 || month > 12) {
    throw new RangeError(`setByMonth invalid month, must be 1 to 12: ${month}`)
  }
...
export const setByDay = (date: Date, day: MonthDays): Date => {
  if (day < 1 || day > 31) {
